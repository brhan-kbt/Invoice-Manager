...
function AddUser() {
    ...
    const [formData, setFormData] = useState<FormData>({
      ...
      const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axiosInstance.post( `${process.env.NEXT_PUBLIC_API_URL}/users`, formData);
            ...
            <div className="w-full p-4 ">
              ...
              <div className="mb-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <select name="role" id="role" onChange={handleInputChange} className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none">
