...
const Login: React.FC = () => {
  ...
  const togglePasswordVisibility = () => {
   ...
   if (typeof window !== "undefined" ? localStorage.getItem('invoice-token') : null) {
     router.push("/");
    //  return  <Loader />
   }
  return (
        ...
        <div className="flex flex-wrap items-center h-full" >
          ...
          <div className="w-full border-stroke  xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-center text-2xl font-bold text-gray-500  sm:text-title-xl2">
                Sign Up with
                <span className="text-white font-bold mx-1  bg-blue-600 italic px-1 py-1"> InvoiceEase</span>
              </h2>
              ...
              <div className="mb-4">
                ...
                <p className="text-center text-black">Already have an account? <Link className="text-[#004AAD] font-bold" href="/login"> Login here</Link> </p>
              </form>
            </div>
          </div>
        </div>
