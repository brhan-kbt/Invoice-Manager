...
function Header() {
  ...
  return (
    <div className='px-3 sm:px-10 md:px-20 py-5 shadow-bottom shadow-2xl flex justify-between'>
        <div>
        ...
        <nav className='flex justify-between items-center'>
            <div className='hidden gap-10 sm:flex'>
                ...
                <Link href="/invoices">
                {
                  userRole === "ADMIN"?"Invoices":"My Invoices"
                }

                 </Link>
                 {
                   userRole === "ADMIN"?<Link href="/users">Users</Link>:null
                 }
                                      <button
          onClick={Logout}
        className="flex items-center gap-1 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
          {/* <svg
                    ...
                    z-10
                     border border-gray-200
                      ...
                      >
                        ...
                        {
                          userRole === "ADMIN"?<Link href="/users" onClick={closeMenu}>Users</Link>:null
                        }
